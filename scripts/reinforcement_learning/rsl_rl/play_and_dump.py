...
"""Script to play a checkpoint if an RL agent from RSL-RL and dump camera frames."""
...
parser.add_argument("--dump", action="store_true", default=False, help="Replicator dump during play.")
...
# Camera and replicator imports for dump functionality
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    """Play with RSL-RL agent and dump camera frames."""
    ...
    # Enable high-quality rendering for dump
